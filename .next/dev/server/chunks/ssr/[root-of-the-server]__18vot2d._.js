...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/notificationEngine.js [app-ssr] (ecmascript)");
...
const AppProvider = ({ children })=>{
    const [users, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        ...
        try {
            ...
            return Array.isArray(parsed) ? parsed.filter((u)=>u.active !== false && u.role !== 'DELETED' && !delSet.has(u.id) && !delSet.has(u.username) && !delSet.has(u.name)) : INITIAL_USERS.filter((u)=>!delSet.has(u.id) && !delSet.has(u.username) && !delSet.has(u.name));
        } catch (e) {
    ...
    const [activeUser, setActiveUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
    ...
    const [notifications, setNotifications] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
        ...
        return saved ? JSON.parse(saved) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INITIAL_NOTIFICATIONS"];
    });
    const [supabaseConfig, setSupabaseConfigState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
    ...
    const [toastAlert, setToastAlert] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const lastSyncServerTimestampRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useRef(0);
    const isRemoteUpdateRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useRef(false);
    // Supabase Realtime Database Subscriptions & Fetching
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSupabaseClient"])(supabaseConfig.url, supabaseConfig.anonKey);
        if (!client) return;
        let isMounted = true;
        const fetchInitialData = async ()=>{
            try {
                ...
                if (!reqErr && Array.isArray(remoteReqs) && isMounted) {
                    ...
                    const mapped = remoteReqs.filter((r)=>r.status !== 'DELETED' && !deletedReqSet.has(r.id)).map((r)=>({
                            id: r.id,
    ...
    const [commonIp, setCommonIpState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
   ...
   */ const getRequiredAuthorityForDiscount = (discountPercent, discountAmount = 0, targetRoleOverride = '')=>{
    ...
    const createDiscountRequest = (newReqData)=>{
        ...
        if (approverUser) {
            const smsAlert = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendNotification"])({
                type: 'SMS',
            ...
            const emailAlert = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendNotification"])({
                type: 'EMAIL',
                recipient: approverUser,
                role: approverUser.designation || initialApproverRole,
                requestCode,
    ...
    const createDirectExecutiveGrant = (grantData)=>{
        ...
        const notif = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendNotification"])({
            type: 'SMS',
    ...
    const [dailyBackups, setDailyBackups] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
    ...
    const [autoDownloadDailyBackup, setAutoDownloadDailyBackupState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>{
...
const useApp = ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AppContext);
}),
...
const getSupabaseClient = (customUrl, customKey)=>{
    ...
    try {
        cachedClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(url, key, {
            realtime: {
                params: {
                    eventsPerSecond: 10
                }
...
"[project]/src/utils/notificationEngine.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18vot2d._.js.map