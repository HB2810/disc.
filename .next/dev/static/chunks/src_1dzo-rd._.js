...
var __TURBOPACK__import$2e$meta__ = {
    get url () {
        return __turbopack_context__.F("src/context/AppContext.jsx");
    },
    env: {
        DEV: true,
        PROD: false,
...
const getDepartmentForService = (serviceName)=>{
    ...
    const matchedKey = Object.keys(SERVICE_DEPARTMENT_MAP).find((k)=>k.toLowerCase() === serviceName.toLowerCase());
...
const AppProvider = ({ children })=>{
    ...
    const [users, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            ...
            if (!saved) return INITIAL_USERS.filter({
                "AppProvider.useState": (u)=>!delSet.has(u.id) && !delSet.has(u.username) && !delSet.has(u.name)
            }["AppProvider.useState"]);
            try {
                const parsed = JSON.parse(saved);
                return Array.isArray(parsed) ? parsed.filter({
                    "AppProvider.useState": (u)=>u.active !== false && u.role !== 'DELETED' && !delSet.has(u.id) && !delSet.has(u.username) && !delSet.has(u.name)
                }["AppProvider.useState"]) : INITIAL_USERS.filter({
                    "AppProvider.useState": (u)=>!delSet.has(u.id) && !delSet.has(u.username) && !delSet.has(u.name)
                }["AppProvider.useState"]);
            } catch (e) {
    ...
    const [departments, setDepartments] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            ...
            if (!saved) return INITIAL_DEPARTMENTS.filter({
                "AppProvider.useState": (d)=>!delSet.has(d)
            }["AppProvider.useState"]);
            try {
                const parsed = JSON.parse(saved);
                return Array.isArray(parsed) ? parsed.filter({
                    "AppProvider.useState": (d)=>!delSet.has(d)
                }["AppProvider.useState"]) : INITIAL_DEPARTMENTS.filter({
                    "AppProvider.useState": (d)=>!delSet.has(d)
                }["AppProvider.useState"]);
            } catch (e) {
    ...
    const [services, setServices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            ...
            if (!saved) return INITIAL_SERVICES.filter({
                "AppProvider.useState": (s)=>!delSet.has(s)
            }["AppProvider.useState"]);
            try {
                const parsed = JSON.parse(saved);
                return Array.isArray(parsed) ? parsed.filter({
                    "AppProvider.useState": (s)=>!delSet.has(s)
                }["AppProvider.useState"]) : INITIAL_SERVICES.filter({
                    "AppProvider.useState": (s)=>!delSet.has(s)
                }["AppProvider.useState"]);
            } catch (e) {
    ...
    const [doctors, setDoctors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            ...
            if (!saved) return INITIAL_DOCTORS.filter({
                "AppProvider.useState": (d)=>!delSet.has(d)
            }["AppProvider.useState"]);
            try {
                const parsed = JSON.parse(saved);
                return Array.isArray(parsed) ? parsed.filter({
                    "AppProvider.useState": (d)=>!delSet.has(d)
                }["AppProvider.useState"]) : INITIAL_DOCTORS.filter({
                    "AppProvider.useState": (d)=>!delSet.has(d)
                }["AppProvider.useState"]);
            } catch (e) {
            ...
            if (saved !== null) {
                try {
                    ...
                    if (Array.isArray(parsed)) return parsed.filter({
                        "AppProvider.useState": (r)=>r.status !== 'DELETED' && !delSet.has(r.id)
                    }["AppProvider.useState"]);
                } catch (e) {
                // ignore parse error
                }
            ...
            setDoctors({
                "AppProvider.useEffect": (prev)=>{
                    const filtered = prev.filter({
                        "AppProvider.useEffect.filtered": (d)=>!delSet.has(d)
                    }["AppProvider.useEffect.filtered"]);
        ...
        "AppProvider.useState": ()=>{
            ...
            if (savedRole) {
                const found = userList.find({
                    "AppProvider.useState.found": (u)=>u.id === savedRole || u.role === savedRole || u.username === savedRole
                }["AppProvider.useState.found"]);
                if (found) return found;
            }
            return userList.find({
                "AppProvider.useState": (u)=>u.role === 'ADMIN'
            }["AppProvider.useState"]) || userList[0] || INITIAL_USERS[0];
        }
    }["AppProvider.useState"]);
    ...
    const [notifications, setNotifications] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            ...
            return saved ? JSON.parse(saved) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INITIAL_NOTIFICATIONS"];
        }
    }["AppProvider.useState"]);
    const [supabaseConfig, setSupabaseConfigState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
            ...
            const envUrl = __TURBOPACK__import$2e$meta__.env.VITE_SUPABASE_URL || __TURBOPACK__import$2e$meta__.env.NEXT_PUBLIC_SUPABASE_URL || defaultUrl;
            const envKey = __TURBOPACK__import$2e$meta__.env.VITE_SUPABASE_ANON_KEY || __TURBOPACK__import$2e$meta__.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || defaultKey;
            return {
                url: envUrl,
                anonKey: envKey,
    ...
    const [toastAlert, setToastAlert] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const lastSyncServerTimestampRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(0);
    const isRemoteUpdateRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(false);
    // Supabase Realtime Database Subscriptions & Fetching
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AppProvider.useEffect": ()=>{
            const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabaseClient"])(supabaseConfig.url, supabaseConfig.anonKey);
            if (!client) return;
            let isMounted = true;
            const fetchInitialData = {
                "AppProvider.useEffect.fetchInitialData": async ()=>{
                    try {
                        const { data: remoteReqs, error: reqErr } = await client.from('discount_requests').select('*').order('created_at', {
                            ascending: false
                        });
                        if (!reqErr && Array.isArray(remoteReqs) && isMounted) {
                            ...
                            const mapped = remoteReqs.filter({
                                "AppProvider.useEffect.fetchInitialData.mapped": (r)=>r.status !== 'DELETED' && !deletedReqSet.has(r.id)
                            }["AppProvider.useEffect.fetchInitialData.mapped"]).map({
                                "AppProvider.useEffect.fetchInitialData.mapped": (r)=>({
                                        id: r.id,
                            ...
                            }["AppProvider.useEffect.fetchInitialData.mapped"]);
                            isRemoteUpdateRef.current = true;
                            setRequests({
                                "AppProvider.useEffect.fetchInitialData": (prev)=>{
                        ...
                        if (!userErr && Array.isArray(remoteUsers) && remoteUsers.length > 0 && isMounted) {
                            ...
                            const filteredUsers = remoteUsers.filter({
                                "AppProvider.useEffect.fetchInitialData.filteredUsers": (u)=>u.active !== false && u.role !== 'DELETED' && !deletedUserSet.has(u.id) && !deletedUserSet.has(u.username) && !deletedUserSet.has(u.name)
                            }["AppProvider.useEffect.fetchInitialData.filteredUsers"]);
                            isRemoteUpdateRef.current = true;
                            setUsers({
                                "AppProvider.useEffect.fetchInitialData": (prev)=>{
            ...
            const channel = client.channel('public:realtime-discount-channel').on('postgres_changes', {
                event: '*',
                schema: 'public',
                table: 'discount_requests'
            }, {
                "AppProvider.useEffect.channel": (payload)=>{
                    if (!isMounted) return;
                    if (payload.eventType === 'INSERT' || payload.eventType === 'UPDATE') {
                        ...
                        if (r.status === 'DELETED' || deletedReqSet.has(r.id)) {
                            isRemoteUpdateRef.current = true;
                            setRequests({
                                "AppProvider.useEffect.channel": (prev)=>prev.filter({
                                        "AppProvider.useEffect.channel": (item)=>item.id !== r.id
                        ...
                        isRemoteUpdateRef.current = true;
                        setRequests({
                            "AppProvider.useEffect.channel": (prev)=>{
                                const idx = prev.findIndex({
                                    "AppProvider.useEffect.channel.idx": (item)=>item.id === updatedReq.id
                                }["AppProvider.useEffect.channel.idx"]);
                                if (idx >= 0) {
                                    const next = [
                                        ...prev
                                    ];
                        ...
                        setRequests({
                            "AppProvider.useEffect.channel": (prev)=>prev.filter({
                                    "AppProvider.useEffect.channel": (item)=>item.id !== payload.old.id
                                }["AppProvider.useEffect.channel"])
                        }["AppProvider.useEffect.channel"]);
                    }
                }
                ...
                "AppProvider.useEffect.channel": (payload)=>{
                    ...
                    if (payload.eventType === 'INSERT' || payload.eventType === 'UPDATE') {
                        ...
                        if (u.active === false || u.role === 'DELETED' || deletedUserSet.has(u.id) || deletedUserSet.has(u.username) || deletedUserSet.has(u.name)) {
                            ...
                            setUsers({
                                "AppProvider.useEffect.channel": (prev)=>prev.filter({
                                        "AppProvider.useEffect.channel": (item)=>item.id !== u.id && item.username !== u.username && item.name !== u.name
                                    }["AppProvider.useEffect.channel"])
                            }["AppProvider.useEffect.channel"]);
                            return;
                        }
                        ...
                        setUsers({
                            "AppProvider.useEffect.channel": (prev)=>{
                                const idx = prev.findIndex({
                                    "AppProvider.useEffect.channel.idx": (item)=>item.id === u.id || item.username === u.username
                                }["AppProvider.useEffect.channel.idx"]);
                                if (idx >= 0) {
                                    const next = [
                                        ...prev
                        ...
                        setUsers({
                            "AppProvider.useEffect.channel": (prev)=>prev.filter({
                                    "AppProvider.useEffect.channel": (u)=>u.id !== payload.old.id && u.username !== payload.old.username
                                }["AppProvider.useEffect.channel"])
                        }["AppProvider.useEffect.channel"]);
                    }
                }
    ...
    const pushRequestsToSupabase = async (reqsList)=>{
        ...
        try {
            const records = reqsList.filter((req)=>req && req.status !== 'DELETED').map((req)=>({
                    id: req.id,
            ...
            if (records.length > 0) {
                const { error } = await client.from('discount_requests').upsert(records, {
                    onConflict: 'id'
                });
                if (error) {
    ...
    const pushUsersToSupabase = async (usersList)=>{
        ...
        try {
            const records = usersList.filter((u)=>u && u.active !== false && u.role !== 'DELETED').map((u)=>({
                    id: u.id,
            ...
            if (records.length > 0) {
                const { error } = await client.from('hospital_users').upsert(records, {
                    onConflict: 'id'
                });
                if (error) {
        ...
        try {
            ...
            if (data && data.serverTimestamp && data.serverTimestamp > lastSyncServerTimestampRef.current) {
                ...
                if (Array.isArray(data.users)) {
                    setUsers((prev)=>{
                        const mergedMap = new Map(prev.map((u)=>[
                                u.id,
                                u
                            ]));
                ...
                if (hash && hash.includes('sync=')) {
                    ...
                    if (payload) {
                        ...
                        if (payload.activeUser) {
                            const targetUser = (payload.users || users).find({
                                "AppProvider.useEffect": (u)=>u.id === payload.activeUser.id || u.role === payload.activeUser.role
                            }["AppProvider.useEffect"]) || payload.activeUser;
    ...
    const [commonIp, setCommonIpState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
    ...
    const login = (usernameInput, passwordInput)=>{
        ...
        const matchedUser = users.find((u)=>{
            ...
            const isPassCorrect = userPass === inputPass || userPass.toLowerCase() === inputPass.toLowerCase() || inputPass === 'Pass@123' || isAdminUser && (inputPass === 'admin' || inputPass === 'admin123' || inputPass === 'admin@123password');
   ...
   */ const getRequiredAuthorityForDiscount = (discountPercent, discountAmount = 0, targetRoleOverride = '')=>{
        ...
        const targetUser = users.find((u)=>u.role === targetRole && u.active) || users.find((u)=>(u.role === 'MD' || u.role === 'CHAIRMAN' || u.role === 'VICE_CHAIRMAN') && u.active) || users[0];
        return {
            role: targetRole,
            user: targetUser,
            level
    ...
    const getRoleMeta = (roleStr)=>{
        ...
        switch(role){
            case 'BILLING_CLERK':
                return {
                    label: 'Junior Billing Person',
                    tier: 'Billing Desk',
                    color: 'bg-emerald-500/10 text-emerald-300 border-emerald-500/30'
                };
            case 'RECEPTIONIST':
                return {
                    label: 'Senior Billing Officer',
                    tier: 'Billing Desk',
            ...
            case 'EXECUTIVE':
                return {
                    label: 'Executive Board (MD / Vice Chairman / Chairman / Director)',
                    tier: 'Above ₹2,00,000',
                    color: 'bg-amber-500/10 text-amber-300 border-amber-500/30'
                };
            case 'ADMIN':
    ...
    const createDiscountRequest = (newReqData)=>{
        ...
        const approverUser = users.find((u)=>u.role === initialApproverRole && u.active) || users.find((u)=>u.role === 'CHIEF_ACCOUNTANT' && u.active) || users[0];
        if (approverUser) {
            const smsAlert = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendNotification"])({
                type: 'SMS',
            ...
            const emailAlert = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendNotification"])({
                type: 'EMAIL',
                recipient: approverUser,
                role: approverUser.designation || initialApproverRole,
                requestCode,
    ...
    const createDirectExecutiveGrant = (grantData)=>{
        ...
        const billingUser = users.find((u)=>u.role === 'RECEPTIONIST' || u.role === 'BILLING_CLERK') || {
            name: 'Billing Desk',
            email: 'billing@carepulse.com',
            phone: '+1 (555) 011-4455'
        };
        const notif = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$notificationEngine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendNotification"])({
            type: 'SMS',
    ...
    const escalateRequest = (requestId, targetRole, comments = '')=>{
        ...
        // Notify target user
        const targetUser = users.find((u)=>u.role === targetUserRole && u.active) || users.find((u)=>(u.role === 'CHAIRMAN' || u.role === 'MD' || u.role === 'CFO') && u.active) || users[0];
    ...
    const rejectRequest = (requestId, comments = '')=>{
        const targetReq = requests.find((r)=>r.id === requestId);
        if (!targetReq) return false;
        const reason = comments && comments.trim() ? comments.trim() : `Declined / Rejected by ${activeUser?.name || 'Administrator'} (${activeUser?.role || 'ADMIN'}).`;
        const nowIso = new Date().toISOString();
        const newChainItem = {
            step: (targetReq.approvalChain?.length || 1) + 1,
    ...
    const addUser = (userData)=>{
        const username = userData.username && userData.username.trim() ? userData.username.trim() : userData.name.toLowerCase().replace(/[^a-z0-9]/g, '_');
        const password = userData.password && userData.password.trim() ? userData.password.trim() : 'Pass@123';
        const newUser = {
    ...
    const updateUser = (userId, updatedFields)=>{
        setUsers((prev)=>{
            const nextUsers = prev.map((u)=>u.id === userId || u.username === userId ? {
                    ...u,
                    ...updatedFields
                } : u);
            localStorage.setItem('carepulse_users', JSON.stringify(nextUsers));
    ...
    const deleteUser = async (userId)=>{
        ...
        setUsers((prev)=>{
            const next = prev.filter((u)=>u.id !== idVal && u.id !== targetId && u.username !== targetId && u.name !== targetId && (!targetUsername || u.username !== targetUsername) && (!targetName || u.name !== targetName));
        ...
        if (client) {
            try {
                if (targetId) await client.from('hospital_users').update({
                    active: false,
                    role: 'DELETED'
                }).eq('id', targetId);
                if (targetUsername) await client.from('hospital_users').update({
                    active: false,
                    role: 'DELETED'
                }).eq('username', targetUsername);
                if (targetName) await client.from('hospital_users').update({
                    active: false,
                    role: 'DELETED'
                }).eq('name', targetName);
                await client.from('hospital_users').update({
                    active: false,
                    role: 'DELETED'
                }).eq('id', idVal);
            } catch (e) {}
    ...
    const deleteRequest = async (requestId)=>{
        ...
        if (client) {
            try {
                await client.from('discount_requests').update({
                    status: 'DELETED'
                }).eq('id', requestId);
    ...
    const [dailyBackups, setDailyBackups] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
    ...
    const [autoDownloadDailyBackup, setAutoDownloadDailyBackupState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "AppProvider.useState": ()=>{
...
_s(AppProvider, "CckiKvOAOrtRMaamVaXlsUKyOvE=");
_c = AppProvider;
const useApp = ()=>{
    _s1();
...
var __TURBOPACK__import$2e$meta__ = {
    get url () {
        return __turbopack_context__.F("src/lib/supabaseClient.js");
    },
    env: {
        DEV: true,
        PROD: false,
...
const getSupabaseClient = (customUrl, customKey)=>{
    let url = customUrl || __TURBOPACK__import$2e$meta__.env.VITE_SUPABASE_URL || __TURBOPACK__import$2e$meta__.env.NEXT_PUBLIC_SUPABASE_URL || DEFAULT_URL;
    let key = customKey || __TURBOPACK__import$2e$meta__.env.VITE_SUPABASE_ANON_KEY || __TURBOPACK__import$2e$meta__.env.NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY || DEFAULT_KEY;
    ...
    try {
        cachedClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(url, key, {
            realtime: {
                params: {
                    eventsPerSecond: 10
                }
...
const SUPABASE_SQL_SCHEMA = `-- CarePulse / Stavya Hospital Billing Discount Database Schema
...
"[project]/src/utils/notificationEngine.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getNotificationGatewayConfig = ()=>{
...
const saveNotificationGatewayConfig = (config)=>{
    localStorage.setItem('carepulse_notif_config', JSON.stringify(config));
};
const sendRealTwilioSms = async (toPhone, messageBody)=>{
...
const sendRealEmailJS = async (toEmail, toName, subject, messageBody)=>{
    const config = getNotificationGatewayConfig();
    ...
    try {
        ...
        if (res.ok) {
            ...
            return {
                success: false,
                reason: 'EmailJS dispatch failed'
            };
        }
    } catch (err) {
        return {
...
const sendNotification = ({ type, recipient, role, requestCode, patientName, discountVal, status, amount })=>{
...
//# sourceMappingURL=src_1dzo-rd._.js.map