...
export const CommonLinkModal = ({ onClose }) => {
  ...
  const [customIpInput, setCustomIpInput] = useState(commonIp && commonIp !== '192.168.7.6' ? commonIp : '192.168.7.64');
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Share & access Stavya Spine Hospital OS from any phone or PC on LAN
              </p>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 text-center space-y-3">
            ...
            <p className="text-[11px] text-slate-300 max-w-xs mx-auto leading-relaxed">
              Scan this QR code with any smartphone camera connected to Wi-Fi to open Stavya Spine Hospital OS instantly.
            </p>
          </div>
